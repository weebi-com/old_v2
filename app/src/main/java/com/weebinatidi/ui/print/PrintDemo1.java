...
public class PrintDemo1 extends Activity {
...
//                    PrintMsg.setVisibility(View.VISIBLE);
                ...
                case BluetoothService.MESSAGE_UNABLE_CONNECT:     //�޷������豸
					Toast.makeText(getApplicationContext(), "connection perdue",
							Toast.LENGTH_SHORT).show();
                    //PrintMsg.setVisibility(View.VISIBLE);
                    //PrintMsg.setText("connection perdue");
                    //PrintLin.setVisibility(View.GONE);
                    finish();
                    break;
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // PrintMsg.setVisibility(View.GONE);
        ...
        if (mService.isAvailable() == false) {
            ...
            Toast.makeText(this, "Veuillez configurer l'imprimante depuis le menu paramètres", Toast.LENGTH_LONG).show();
            finish();
        }
...
//		});
    ...
    public  void GoPrintit() {
        if(isbill==true){
            ...
            Intent bill =new Intent(PrintDemo1.this,InvoiceDetailsActivity.class);
    ...
    public void GoConnectthePrint() {
        ...
        String address = Config.ReadFromBase(PrintDemo1.this, Config.printer, 0);
        ...
        //as there no device saved  please lets start the search first and get one before moving on ....
            ...
            Intent serverIntent = new Intent(PrintDemo1.this, DeviceListActivity.class);      //��������һ����Ļ
